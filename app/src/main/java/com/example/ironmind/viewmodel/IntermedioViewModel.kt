...
class IntermedioViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun inserisciScheda() {
        prefs.edit().putBoolean("schedaIntermedioAttiva", true).apply()
        _navigaADashboard.value = true
    }

    fun eliminaScheda() {
        prefs.edit().putBoolean("schedaIntermedioAttiva", false).apply()
        _navigaADashboard.value = true
    }
